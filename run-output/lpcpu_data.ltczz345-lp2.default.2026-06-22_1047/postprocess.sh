...
${LPCPUDIR}/postprocess/postprocess-ipi . 001 default ./system-topology.dump
else
IPI_NO_NUMA=1 ${LPCPUDIR}/postprocess/postprocess-ipi . 001 default
fi
...
if [ -x ${NDIFF} -a -e ethtool/ethtool-bonding_masters-stats.before.STDOUT -a -e ethtool/ethtool-bonding_masters-stats.after.STDOUT  ]; then ${NDIFF} ethtool/ethtool-bonding_masters-stats.before.STDOUT ethtool/ethtool-bonding_masters-stats.after.STDOUT > ethtool/ethtool-bonding_masters-stats.diff ; fi
if [ -x ${NDIFF} -a -e ethtool/ethtool-en0-stats.before.STDOUT -a -e ethtool/ethtool-en0-stats.after.STDOUT  ]; then ${NDIFF} ethtool/ethtool-en0-stats.before.STDOUT ethtool/ethtool-en0-stats.after.STDOUT > ethtool/ethtool-en0-stats.diff ; fi
if [ -x ${NDIFF} -a -e ethtool/ethtool-enP24p1s0f0np0-stats.before.STDOUT -a -e ethtool/ethtool-enP24p1s0f0np0-stats.after.STDOUT  ]; then ${NDIFF} ethtool/ethtool-enP24p1s0f0np0-stats.before.STDOUT ethtool/ethtool-enP24p1s0f0np0-stats.after.STDOUT > ethtool/ethtool-enP24p1s0f0np0-stats.diff ; fi
if [ -x ${NDIFF} -a -e ethtool/ethtool-enP24p1s0f1np1-stats.before.STDOUT -a -e ethtool/ethtool-enP24p1s0f1np1-stats.after.STDOUT  ]; then ${NDIFF} ethtool/ethtool-enP24p1s0f1np1-stats.before.STDOUT ethtool/ethtool-enP24p1s0f1np1-stats.after.STDOUT > ethtool/ethtool-enP24p1s0f1np1-stats.diff ; fi
